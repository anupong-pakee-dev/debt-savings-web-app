...
#### A modern financial tracking web application built with Next.js @16.1.1, Prisma ORM, and PostgreSQL. This app helps users manage debts, savings goals, transactions, and provides clean, real-time dashboards.
